...
public struct Sanchr_Notifications_SetConversationNotificationPrefsRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Sanchr_Notifications_SetConversationNotificationPrefsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Sanchr_Notifications_SetConversationNotificationPrefsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SetConversationNotificationPrefsRequest"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}conversation_id\0\u{1}muted\0")
  ...
  public static func ==(lhs: Sanchr_Notifications_SetConversationNotificationPrefsRequest, rhs: Sanchr_Notifications_SetConversationNotificationPrefsRequest) -> Bool {
...
extension Sanchr_Notifications_SetConversationNotificationPrefsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SetConversationNotificationPrefsResponse"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Sanchr_Notifications_SetConversationNotificationPrefsResponse, rhs: Sanchr_Notifications_SetConversationNotificationPrefsResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

...
public enum SanchrGradients {
    ...
    public static let primaryDark = LinearGradient(
    ...
    public static let callAccept = LinearGradient(
    ...
    public static let callDecline = LinearGradient(
    ...
    public static let surfaceDark = LinearGradient(
        colors: [
            Color(hex: 0x1A1A24),
            Color(hex: 0x0F0F14),
        ],
    ...
    public static let encryptionShimmer = LinearGradient(
        colors: [

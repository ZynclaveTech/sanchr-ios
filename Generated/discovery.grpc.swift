...
internal protocol Vync_Discovery_DiscoveryServiceClientProtocol: GRPCClient {
...
extension Vync_Discovery_DiscoveryServiceClientProtocol {
  ...
  ///   - callOptions: Call options.
  /// - Returns: A `UnaryCall` with futures for the metadata, status and response.
  internal func getRegisteredSet(
    _ request: Vync_Discovery_GetRegisteredSetRequest,
    callOptions: CallOptions? = nil
  ) -> UnaryCall<Vync_Discovery_GetRegisteredSetRequest, Vync_Discovery_GetRegisteredSetResponse> {
    return self.makeUnaryCall(
...
internal final class Vync_Discovery_DiscoveryServiceClient: Vync_Discovery_DiscoveryServiceClientProtocol {
  ...
  internal var interceptors: Vync_Discovery_DiscoveryServiceClientInterceptorFactoryProtocol? {
...
internal struct Vync_Discovery_DiscoveryServiceNIOClient: Vync_Discovery_DiscoveryServiceClientProtocol {
...
internal protocol Vync_Discovery_DiscoveryServiceAsyncClientProtocol: GRPCClient {
...
extension Vync_Discovery_DiscoveryServiceAsyncClientProtocol {
  ...
  internal func makeOprfDiscoverCall(
    _ request: Vync_Discovery_OprfDiscoverRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Vync_Discovery_OprfDiscoverRequest, Vync_Discovery_OprfDiscoverResponse> {
  ...
  internal func makeGetBloomFilterCall(
    _ request: Vync_Discovery_GetBloomFilterRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Vync_Discovery_GetBloomFilterRequest, Vync_Discovery_GetBloomFilterResponse> {
    return self.makeAsyncUnaryCall(
  ...
  internal func makeGetRegisteredSetCall(
    _ request: Vync_Discovery_GetRegisteredSetRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Vync_Discovery_GetRegisteredSetRequest, Vync_Discovery_GetRegisteredSetResponse> {
    return self.makeAsyncUnaryCall(
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal struct Vync_Discovery_DiscoveryServiceAsyncClient: Vync_Discovery_DiscoveryServiceAsyncClientProtocol {
  internal var channel: GRPCChannel
  internal var defaultCallOptions: CallOptions
  internal var interceptors: Vync_Discovery_DiscoveryServiceClientInterceptorFactoryProtocol?
...
internal protocol Vync_Discovery_DiscoveryServiceClientInterceptorFactoryProtocol: Sendable {
...
internal enum Vync_Discovery_DiscoveryServiceClientMetadata {
...
internal protocol Vync_Discovery_DiscoveryServiceProvider: CallHandlerProvider {
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol Vync_Discovery_DiscoveryServiceAsyncProvider: CallHandlerProvider, Sendable {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Vync_Discovery_DiscoveryServiceServerInterceptorFactoryProtocol? { get }
...
extension Vync_Discovery_DiscoveryServiceAsyncProvider {
  ...
  internal var interceptors: Vync_Discovery_DiscoveryServiceServerInterceptorFactoryProtocol? {
    return nil
  }
...
internal protocol Vync_Discovery_DiscoveryServiceServerInterceptorFactoryProtocol: Sendable {
...
internal enum Vync_Discovery_DiscoveryServiceServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "DiscoveryService",
    fullName: "vync.discovery.DiscoveryService",
    methods: [

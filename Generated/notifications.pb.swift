...
struct Vync_Notifications_RegisterPushTokenRequest: Sendable {
...
struct Vync_Notifications_RegisterPushTokenResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Vync_Notifications_UpdateNotificationPrefsRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Vync_Notifications_UpdateNotificationPrefsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Vync_Notifications_RegisterPushTokenRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Vync_Notifications_RegisterPushTokenRequest, rhs: Vync_Notifications_RegisterPushTokenRequest) -> Bool {
...
extension Vync_Notifications_RegisterPushTokenResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Vync_Notifications_RegisterPushTokenResponse, rhs: Vync_Notifications_RegisterPushTokenResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Vync_Notifications_UpdateNotificationPrefsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Vync_Notifications_UpdateNotificationPrefsRequest, rhs: Vync_Notifications_UpdateNotificationPrefsRequest) -> Bool {
...
extension Vync_Notifications_UpdateNotificationPrefsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Vync_Notifications_UpdateNotificationPrefsResponse, rhs: Vync_Notifications_UpdateNotificationPrefsResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

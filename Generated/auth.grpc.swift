...
internal protocol Vync_Auth_AuthServiceClientProtocol: GRPCClient {
...
internal final class Vync_Auth_AuthServiceClient: Vync_Auth_AuthServiceClientProtocol {
  ...
  internal var interceptors: Vync_Auth_AuthServiceClientInterceptorFactoryProtocol? {
...
internal struct Vync_Auth_AuthServiceNIOClient: Vync_Auth_AuthServiceClientProtocol {
...
internal protocol Vync_Auth_AuthServiceAsyncClientProtocol: GRPCClient {
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal struct Vync_Auth_AuthServiceAsyncClient: Vync_Auth_AuthServiceAsyncClientProtocol {
  internal var channel: GRPCChannel
  internal var defaultCallOptions: CallOptions
  internal var interceptors: Vync_Auth_AuthServiceClientInterceptorFactoryProtocol?
...
internal protocol Vync_Auth_AuthServiceClientInterceptorFactoryProtocol: Sendable {
...
internal enum Vync_Auth_AuthServiceClientMetadata {
...
internal protocol Vync_Auth_AuthServiceProvider: CallHandlerProvider {
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol Vync_Auth_AuthServiceAsyncProvider: CallHandlerProvider, Sendable {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Vync_Auth_AuthServiceServerInterceptorFactoryProtocol? { get }
...
extension Vync_Auth_AuthServiceAsyncProvider {
  ...
  internal var interceptors: Vync_Auth_AuthServiceServerInterceptorFactoryProtocol? {
    return nil
  }
...
internal protocol Vync_Auth_AuthServiceServerInterceptorFactoryProtocol: Sendable {
...
internal enum Vync_Auth_AuthServiceServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "AuthService",
    fullName: "vync.auth.AuthService",
    methods: [
